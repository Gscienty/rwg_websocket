...
rwg_staticfile::mime::mime() {}

void rwg_staticfile::mime::read_config(std::string config_file) {
...
std::string rwg_staticfile::mime::get(std::string ext) const {
...
std::string rwg_staticfile::mime::default_mime() const {
    return this->_default;
}
